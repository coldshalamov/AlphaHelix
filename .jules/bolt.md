...
## 2024-07-24 - [Static Animation Hydration Anti-pattern]
...
**Action:** Always apply static CSS animation classes directly to elements in the JSX to prevent unnecessary renders and speed up FCP.
