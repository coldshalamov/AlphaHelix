...
## 2024-07-13 - Static Animation Hydration optimization in Next.js
...
**Action:** Always apply static CSS animation classes directly to elements in the JSX to avoid extra re-renders and blocking UI changes on hydration.
