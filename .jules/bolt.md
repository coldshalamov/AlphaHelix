...
**Learning:** Unbounded Wagmi `useReadContracts` multicalls mapped to total contract counters (e.g., `marketCount`) cause O(N) payload explosions and slow render times.
