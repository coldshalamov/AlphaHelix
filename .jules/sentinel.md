...
## 2026-04-07 - Refactored _submitStatementInternal to comply with CEI
**Vulnerability:** External calls within conditional statements.
**Learning:** The CEI pattern dictates that external interactions like `token.burn` within conditional branches should calculate amounts locally to defer external calls to the end of the state changes.
**Prevention:** Perform calculations first, log events, and execute external calls last.
