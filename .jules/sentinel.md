...
## 2026-08-28 - Randomness Grinding via msg.sender
**Vulnerability:** The on-chain global randomness for market closures included user-controllable variables (msg.sender) in the entropy pool.
**Learning:** Including msg.sender in keccak256 randomness calculations allows attackers to grind the randomness via proxy contracts or CREATE2, forcing desired market closure outcomes.
**Prevention:** Never include user-controllable variables like msg.sender or tx.origin in the entropy pool when calculating on-chain global randomness.
