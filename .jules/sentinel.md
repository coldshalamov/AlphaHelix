...
## 2024-09-10 - Randomness Grinding Vulnerability
**Vulnerability:** User-controllable variables like msg.sender were included in the keccak256 entropy pool for determining market closures.
**Learning:** Attackers can grind randomness by creating ephemeral proxy contracts (altering msg.sender) until the desired hash difficulty is achieved, forcing the market to close prematurely.
**Prevention:** Never include user-controllable variables like msg.sender or tx.origin in global entropy pools used for critical state transitions.
