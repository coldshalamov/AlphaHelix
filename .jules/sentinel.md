...
## 2026-04-24 - Predictable Randomness in Market Seed
**Vulnerability:** Using only predictable elements like block.timestamp, msg.sender, and blockhash for generating random seeds is vulnerable to manipulation.
**Learning:** Post-Merge Ethereum requires using block.prevrandao as a more secure source of pseudo-randomness.
**Prevention:** Always include block.prevrandao in keccak256 payloads when generating random seeds in Ethereum post-Merge.
