...
## 2024-05-26 - Checks-Effects-Interactions (CEI) Pattern Violation in conditionals
**Vulnerability:** External interactions within conditional branches before state updates.
**Learning:** When external interactions are within conditional branches, calculate the parameters inside the branch and move the interaction to the end of the function to strictly adhere to the Checks-Effects-Interactions (CEI) pattern.
**Prevention:** Refactor external interactions embedded in conditional branches to the end of the function.
