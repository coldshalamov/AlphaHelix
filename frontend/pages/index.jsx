...
export default function Home() {
  // BOLT: Removed lazy JS-hydrated animation classes (useState/useEffect) and initial opacity:0 states.
  // Static server-rendered classes improve First Contentful Paint (FCP), prevent unnecessary re-renders,
  // and ensure elements remain visible if JS fails.
  return (
