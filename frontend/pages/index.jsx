...
export default function Home() {
  // BOLT: Removed `useEffect` lazy JS-hydrated animations to improve First Contentful Paint (FCP).
  // Static CSS classes now trigger immediately upon CSS load, eliminating an unnecessary full-page re-render on mount.
  return (
