          ...
          <Link href="/">
            <div className="banner-crop">
              <Image
                ...
                priority
                // BOLT: Explicitly define sizes constrained by the container's max-width (1200px)
                // to prevent browsers from downloading unnecessarily large images on wide viewports.
