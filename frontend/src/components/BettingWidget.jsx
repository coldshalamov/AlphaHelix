...
function BettingWidget({
  ...
  const handleCommit = async () => {
    ...
    try {
      ...
      // BOLT: Replaced Array.from(buffer).map(...).join('') with native viem bytesToHex()
      // This eliminates intermediate array allocations and string creation overhead when generating the salt.
      const salt = BigInt(
