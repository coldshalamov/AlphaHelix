...
function BettingWidget({
  ...
  const handleCommit = async () => {
    ...
    try {
      ...
      // BOLT: Replaced Array.from(randomBuffer).map() string building with Viem's native bytesToHex
      // to eliminate intermediate array allocation and garbage collection overhead during commit generation.
