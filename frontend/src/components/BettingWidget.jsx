...
function BettingWidget({
  ...
  const handleCommit = async () => {
    ...
    try {
      ...
      // BOLT: Replaced inefficient Array.from().map().join() hex generation with viem's bytesToHex
      // to eliminate intermediate array allocations, string creations, and garbage collection overhead.
