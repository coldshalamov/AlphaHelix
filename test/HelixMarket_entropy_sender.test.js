...
describe("HelixMarket Sender Grinding Security", function () {
  let token, market;
  let deployer, user1;
  let marketId;
  ...
  it("should generate SAME hashes for different senders (Fix Verified)", async function () {
    ...
    // Check previewCloseCheck from deployer
    ...
    // Fix Verified: Hashes should be identical because msg.sender is removed
