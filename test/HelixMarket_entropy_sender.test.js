...
describe("HelixMarket Sender Entropy Vulnerability", function () {
  let token, market;
  ...
  it("should generate SAME hashes for different senders (Sender Grinding Fix Verified)", async function () {
    ...
    // Fix: Hashes should be EQUAL because msg.sender is removed from entropy
