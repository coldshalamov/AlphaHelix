...
describe("HelixMarket Randomness Security", function () {
  let token, market, reserve;
  let deployer, user1;
  let marketId;
  ...
  it("should generate SAME hashes for different gas prices (Fix Verified)", async function () {
