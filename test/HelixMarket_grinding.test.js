...
describe("HelixMarket Randomness Grinding", function () {
  ...
  it("should generate IDENTICAL hashes for different senders (Vulnerability Fixed)", async function () {
    ...
    // Vulnerability FIXED: Hashes SHOULD be identical because msg.sender is removed
