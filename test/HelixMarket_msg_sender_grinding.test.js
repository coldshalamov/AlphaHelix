...
describe("HelixMarket Msg.Sender Grinding Vulnerability", function () {
  let token, market;
  ...
  it("should produce IDENTICAL hashes for different senders (Fix Verified)", async function () {
    ...
    // Fix behavior: Hashes are identical because msg.sender is removed
