...
describe("HelixMarket Randomness Security - Msg Sender Grinding", function () {
  let token, market;
  ...
  beforeEach(async function () {
    ...
    // Mint tokens and approve (needed for submitStatement)
  ...
  it("should generate SAME hashes for different msg.sender (Fix Verified)", async function () {
    // Advance time to allow random close check (past minCommitDuration)
    ...
    // Check previewCloseCheck with user2
    ...
    // Hashes should be identical (msg.sender ignored)
