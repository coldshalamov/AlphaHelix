...
describe("HelixMarket Randomness Sender Security", function () {
  let token, market;
  ...
  it("should generate SAME hashes for different senders (Address Grinding Protection)", async function () {
