...
describe("HelixMarket Address Grinding Security", function () {
  let token, market;
  ...
  it("should generate the SAME hash for different senders to prevent Address Grinding", async function () {
