...
## 2025-02-18 - [Helper Action Focus]
**Learning:** Helper buttons that modify input values (like "Max" buttons) leave assistive technology users disoriented if focus remains on the button after the input updates.
